            ...
            <div class="priorities" id="priorities">
                <div class="priorities-header">
                    ...
                    <div class="priorities-nav">
                        <ul id="taskNav">
                            <a class="navs act-nav" id="upcoming"><li>Upcoming</li></a>
                ...
                <div class="priorities-list" id="priorities-list">
                    <div class="priority">
                        ...
                        <form action="" id="formPriorities">
                            <div class="tasks">
                                ...
                                <input type="submit" value="ADD" name="addPriority" id="addPriority" onclick="return empty()">
                            </div>
                        </form>
                    </div>
                    ...
                    foreach ($priorities as $priority) {?>
                        <div class="priority">
                            <div>
                                <form method="post" action="index.php?completeTask" id="priority<?=$priority['priorityId']?>">
                            ...
                            <section class="model-content" id="display">
                                <form method="POST" action="index.php?create">
                                    ...
                                    <select name="project" id="">
                                        <?php
                                            $projects = $con->userProject($login_id);
                                            if(!empty($projects))
                                            {
                                                foreach($projects as $project)
                                                {?>
                                                    <option value="<?php echo $project['pId'];?>"><?php echo $project['name'];?></option>
                                            <?php } 
                                        }?>
                                    </select>
